...
class _MessageDetailSheetState extends State<_MessageDetailSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final needsAction = isCreated || isReminder;
        ...
        child: Column(
          ...
          children: [
            ...
            if (isCreated) ...[
              ...
              const Text('操作', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xFF1F2329))),
              ...
              if (_selectedAction == 'reject') ...[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(hintText: '请输入理由', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: Color(0xFFE5E6EB))), enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: Color(0xFFE5E6EB))), focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: const BorderSide(color: Color(0xFF1D74F5)))),
                ),
              ],
              if (_selectedAction != null) ...[
                ...
                Row(children: [
                  ...
                  Expanded(child: FilledButton(
                    ...
                    style: FilledButton.styleFrom(backgroundColor: _getActionColor(_selectedAction!), padding: const EdgeInsets.symmetric(vertical: 14)),
                    child: _loading ? const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white)) : const Text('确认'),
                  )),
                ]),
              ],
            ] else if (isReminder) ...[
